...
const countries: Country[] = [
  ...
  { flag: '🇱🇰', name: { en: 'Sri Lanka', ar: 'سريلانكا' }, text: { en: 'Profiles may be available from Sri Lanka. INAYA reviews each profile with the family requirement first.', ar: 'قد تتوفر ملفات من سريلانكا. تراجع عناية كل ملف مع احتياج الأسرة أولاً.' }, points: { en: ['Requirements', 'Documents', 'Guidance'], ar: ['المتطلبات', 'المستندات', 'الإرشاد'] } },
